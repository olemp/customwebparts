...
declare module SP {
    ...
    export module ListOperation {
        ...
        export module Selection {
            ...
            export function getSelectedItems(clientContext : SP.ClientContext);
...
declare module SP {
    ...
    export class RequestExecutor {
        ...
        executeAsync(requestInfo:any): void;
...
declare function CountDictionary(clientContext: SP.ClientContext);
declare function CountSelectedItem(clientContext: SP.ClientContext);
declare function CountTotalItems(clientContext: SP.ClientContext);
...
declare module SP.WorkflowServices {
    ...
    export class WorkflowSubscription extends SP.ClientObject {
        ...
        /** This method is internal and is not intended to be used in your code. */
        initPropertiesFromJson(parentNode: any): void;
        constructor(clientContext: SP.ClientContext);
    }
